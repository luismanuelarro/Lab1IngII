...
public class ViajeTest {
    ...
    public void testViajeFamiliar() throws ParseException {
        ...
        ViajeFamiliar viaje = new ViajeFamiliar(5,"Popayán", "Bogotá", 1250000, new SimpleDateFormat("dd/MM/yyyy").parse("01/05/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("05/05/2019"));
    ...
    public void testViajeIncentivo() throws ParseException {
        ...
        ViajeIncentivo viaje = new ViajeIncentivo("Emtel","Popayán", "Medellin", 2100000, new SimpleDateFormat("dd/MM/yyyy").parse("03/06/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("09/06/2019"));
        assertEquals("Popayán", viaje.getOrigen());
